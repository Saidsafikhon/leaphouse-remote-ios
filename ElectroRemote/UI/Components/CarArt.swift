...
enum CarArt {
    ...
    private static let paints: [String: Paint] = [
        ...
        "oxygen-green": Paint(code: "oxygen-green", label: "Свежий зелёный", swatch: Color(hex: 0x9FA88A)),
        "night-blue": Paint(code: "night-blue", label: "Ночной синий", swatch: Color(hex: 0x1C2440)),
        "coral-orange": Paint(code: "coral-orange", label: "Коралловый оранжевый", swatch: Color(hex: 0xE8452A)),
        "rime-beige": Paint(code: "rime-beige", label: "Бежевый иней", swatch: Color(hex: 0xE9E2D2)),
        "cloud-gold": Paint(code: "cloud-gold", label: "Облачное золото", swatch: Color(hex: 0xC9B99A)),
        "pine-grey": Paint(code: "pine-grey", label: "Сосновый серый", swatch: Color(hex: 0x9DA8AC)),
        "liquid-silver": Paint(code: "liquid-silver", label: "Жидкое серебро", swatch: Color(hex: 0xC4C6CB)),
        "cloud-purple": Paint(code: "cloud-purple", label: "Дымчато-фиолетовый", swatch: Color(hex: 0x9C97B0)),
        "morgan-pink": Paint(code: "morgan-pink", label: "Розовый Морган", swatch: Color(hex: 0xD9B8B0)),
    ]
