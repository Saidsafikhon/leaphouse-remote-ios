...
object CarArt {
    ...
    private val PAINTS = mapOf(
        ...
        "oxygen-green" to Paint("oxygen-green", "Свежий зелёный", Color(0xFF9FA88A)),
        "night-blue" to Paint("night-blue", "Ночной синий", Color(0xFF1C2440)),
        "coral-orange" to Paint("coral-orange", "Коралловый оранжевый", Color(0xFFE8452A)),
        "rime-beige" to Paint("rime-beige", "Бежевый иней", Color(0xFFE9E2D2)),
        "cloud-gold" to Paint("cloud-gold", "Облачное золото", Color(0xFFC9B99A)),
        "pine-grey" to Paint("pine-grey", "Сосновый серый", Color(0xFF9DA8AC)),
        "liquid-silver" to Paint("liquid-silver", "Жидкое серебро", Color(0xFFC4C6CB)),
        "cloud-purple" to Paint("cloud-purple", "Дымчато-фиолетовый", Color(0xFF9C97B0)),
        "morgan-pink" to Paint("morgan-pink", "Розовый Морган", Color(0xFFD9B8B0)),
    )
    ...
    private val ART: Map<String, Map<String, Int>> = mapOf(
        ...
        "C11" to mapOf(
            ...
            "rime-beige" to R.drawable.car_c11_rime_beige,
            "metallic-black" to R.drawable.car_c11_metallic_black,
            "canopy-gray" to R.drawable.car_c11_canopy_gray,
            "pine-grey" to R.drawable.car_c11_pine_grey,
            "galaxy-silver" to R.drawable.car_c11_galaxy_silver,
            "cloud-gold" to R.drawable.car_c11_cloud_gold,
            "walden-green" to R.drawable.car_c11_walden_green,
        ),
        "C01" to mapOf(
            "light-white" to R.drawable.car_c01_light_white,
            "metallic-black" to R.drawable.car_c01_metallic_black,
            "canopy-gray" to R.drawable.car_c01_canopy_gray,
            "galaxy-silver" to R.drawable.car_c01_galaxy_silver,
            "oxygen-green" to R.drawable.car_c01_oxygen_green,
            "night-blue" to R.drawable.car_c01_night_blue,
            "coral-orange" to R.drawable.car_c01_coral_orange,
            "glacier-blue" to R.drawable.car_c01_glacier_blue,
        ),
        "B01" to mapOf(
            "light-white" to R.drawable.car_b01_light_white,
            "metallic-black" to R.drawable.car_b01_metallic_black,
            "tundra-grey" to R.drawable.car_b01_tundra_grey,
            "galaxy-silver" to R.drawable.car_b01_galaxy_silver,
            "liquid-silver" to R.drawable.car_b01_liquid_silver,
            "starry-night-blue" to R.drawable.car_b01_starry_night_blue,
            "cloud-purple" to R.drawable.car_b01_cloud_purple,
            "morgan-pink" to R.drawable.car_b01_morgan_pink,
        ),
        "B10" to mapOf(
